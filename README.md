...
## [All specifiers](#all-specifiers)
## [Full API](#full-api)
### [`sscanf(const data[], const format[], {Float, _}:...);`](#sscanfconst-data-const-format-float-_)
### [`unformat(const data[], const format[], {Float, _}:...);`](#unformatconst-data-const-format-float-_)
### [`SSCANF_Option(const name[], value);`](#sscanf_optionconst-name-value)
### [`SSCANF_Option(const name[]);`](#sscanf_optionconst-name)
### [`SSCANF_SetOption(const name[], value);`](#sscanf_setoptionconst-name-value)
### [`SSCANF_GetOption(const name[], value);`](#sscanf_getoptionconst-name-value)
### [`SSCANF_Version(version[], size = sizeof (version));`](#sscanf_versionversion-size--sizeof-version)
### [`SSCANF_Version();`](#sscanf_version)
### [`SSCANF_VersionString(version[], size = sizeof (version));`](#sscanf_versionstringversion-size--sizeof-version)
### [`SSCANF_VersionBCD();`](#sscanf_versionbcd)
### [`SSCANF_VERSION_STRING`](#sscanf_version_string)
### [`SSCANF_VERSION_BCD`](#sscanf_version_bcd)
## [`extract`](#extract)
## [Errors/Warnings](#errorswarnings)
### [MSVRC100.dll not found](#msvrc100dll-not-found)
### [sscanf error: System not initialised](#sscanf-error-system-not-initialised)
### [sscanf warning: String buffer overflow.](#sscanf-warning-string-buffer-overflow)
### [sscanf warning: Optional types invalid in array specifiers, consider using 'A'.](#sscanf-warning-optional-types-invalid-in-array-specifiers-consider-using-a)
### [sscanf warning: Optional types invalid in enum specifiers, consider using 'E'.](#sscanf-warning-optional-types-invalid-in-enum-specifiers-consider-using-e)
### [sscanf error: Multi-dimensional arrays are not supported.](#sscanf-error-multi-dimensional-arrays-are-not-supported)
### [sscanf error: Search strings are not supported in arrays.](#sscanf-error-search-strings-are-not-supported-in-arrays)
### [sscanf error: Delimiters are not supported in arrays.](#sscanf-error-delimiters-are-not-supported-in-arrays)
### [sscanf error: Quiet sections are not supported in arrays.](#sscanf-error-quiet-sections-are-not-supported-in-arrays)
### [sscanf error: Unknown format specifier '?'.](#sscanf-error-unknown-format-specifier-)
### [sscanf warning: Empty default values.](#sscanf-warning-empty-default-values)
### [sscanf warning: Unclosed default value.](#sscanf-warning-unclosed-default-value)
### [sscanf warning: No default value found.](#sscanf-warning-no-default-value-found)
### [sscanf warning: Unenclosed specifier parameter.](#sscanf-warning-unenclosed-specifier-parameter)
### [sscanf warning: No specified parameter found.](#sscanf-warning-no-specified-parameter-found)
### [sscanf warning: Missing string length end.](#sscanf-warning-missing-string-length-end)
### [sscanf warning: Missing length end.](#sscanf-warning-missing-length-end)
### [sscanf error: Invalid data length.](#sscanf-error-invalid-data-length)
### [sscanf error: Invalid character in data length.](#sscanf-error-invalid-character-in-data-length)
### [sscanf error: String/array must include a length, please add a destination size.](#sscanf-error-stringarray-must-include-a-length-please-add-a-destination-size)
### [sscanf warning: Can't have nestled quiet sections.](#sscanf-warning-cant-have-nestled-quiet-sections)
### [sscanf warning: Not in a quiet section.](#sscanf-warning-not-in-a-quiet-section)
### [sscanf warning: Can't remove quiet in enum.](#sscanf-warning-cant-remove-quiet-in-enum)
### [sscanf error: Arrays are not supported in enums.](#sscanf-error-arrays-are-not-supported-in-enums)
### [sscanf warning: Unclosed string literal.](#sscanf-warning-unclosed-string-literal)
### [sscanf warning: sscanf specifiers do not require '%' before them.](#sscanf-warning-sscanf-specifiers-do-not-require--before-them)
### [sscanf error: Insufficient default values.](#sscanf-error-insufficient-default-values)
### [sscanf error: Options are not supported in enums.](#sscanf-error-options-are-not-supported-in-enums)
### [sscanf error: Options are not supported in arrays.](#sscanf-error-options-are-not-supported-in-arrays)
### [sscanf error: No option value.](#sscanf-error-no-option-value)
### [sscanf error: Unknown option name.](#sscanf-error-unknown-option-name)
### [sscanf warning: Could not find function SSCANF:?.](#sscanf-warning-could-not-find-function-sscanf)
### [sscanf error: SSCANF_Init has incorrect parameters.](#sscanf-error-sscanf_init-has-incorrect-parameters)
### [sscanf error: SSCANF_Join has incorrect parameters.](#sscanf-error-sscanf_join-has-incorrect-parameters)
### [sscanf error: SSCANF_Leave has incorrect parameters.](#sscanf-error-sscanf_leave-has-incorrect-parameters)
### [sscanf error: SSCANF_SetPlayerName has incorrect parameters.](#sscanf-error-sscanf_setplayername-has-incorrect-parameters)
### [sscanf error: SSCANF_IsConnected has incorrect parameters.](#sscanf-error-sscanf_isconnected-has-incorrect-parameters)
## [License](#license)
### [Version: MPL 1.1](#version-mpl-11)
### [Contributor(s):](#contributors)
### [Special Thanks to:](#special-thanks-to)
## [Changelog](#changelog)
### [sscanf 2.8.2 - 18/04/2015](#sscanf-282---18042015)
### [sscanf 2.8.3 - 02/10/2018](#sscanf-283---02102018)
### [sscanf 2.9.0 - 04/11/2019](#sscanf-290---04112019)
### [sscanf 2.10.0 - 27/06/2020](#sscanf-2100---27062020)
### [sscanf 2.10.1 - 27/06/2020](#sscanf-2101---27062020)
### [sscanf 2.10.2 - 28/06/2020](#sscanf-2102---28062020)
### [sscanf 2.10.3 - 28/04/2021](#sscanf-2103---28042021)
